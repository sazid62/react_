					...
					<div className="collapse navbar-collapse" id="navbarSupportedContent">
						<div className="_header_form ms-auto">
							<form className="_header_form_grp">
                                ...
                                <input placeholder='asdasds' ></input>
									...
									<div id="_notify_drop" className="_notification_dropdown">
										...
										<div className="_notifications_drop_box">
											...
											<div className="_notifications_all">
												...
												<div className="_notification_box">
													<div className="_notification_image">
														<img src="./src/assets/images/profile-1.png" alt="Image" className="_notify_img"/>
													</div>
													<div className="_notification_txt">
														<p className="_notification_para">
															An admin changed the name of the group 
						...
						<div className="_header_nav_profile">
							<div className="_header_nav_profile_image">
								<img src="./src/assets/images/profile.png" alt="Image" className="_nav_profile_img"/>
							</div>
							...
							<div id="_prfoile_drop" className="_nav_profile_dropdown _profile_dropdown">
								<div className="_nav_profile_dropdown_info">
									<div className="_nav_profile_dropdown_image">
										<img src="./src/assets/images/profile.png" alt="Image" className="_nav_drop_img"/>
									</div>
