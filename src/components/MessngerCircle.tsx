...
export default function MessengerCircle() {
  return (
    <div>
                        ...
                        <li className="_feed_inner_ppl_card_area_item">
                            <a href="#0" className="_feed_inner_ppl_card_area_link">
                                <div className="_feed_inner_ppl_card_area_story">
                                    <img src="./src/assets/images/mobile_story_img.png" alt="Image" className="_card_story_img"/>
                        ...
                        <li className="_feed_inner_ppl_card_area_item">
                            <a href="#0" className="_feed_inner_ppl_card_area_link">
                                <div className="_feed_inner_ppl_card_area_story_active">
                                    <img src="./src/assets/images/mobile_story_img1.png" alt="Image" className="_card_story_img1"/>
                                </div>
                        ...
                        <li className="_feed_inner_ppl_card_area_item">
                            <a href="#0" className="_feed_inner_ppl_card_area_link">
                                <div className="_feed_inner_ppl_card_area_story_inactive">
                                    <img src="./src/assets/images/mobile_story_img2.png" alt="Image" className="_card_story_img1"/>
                                </div>
                                <p className="_feed_inner_ppl_card_area_txt">Ryan...</p>
                            </a>
                        </li>
